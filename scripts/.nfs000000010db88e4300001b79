...
if args.train_data == "asr" or args.train_data == "manu":
    ...
    train_path = os.path.join(args.dataroot, "train_{}_csc.json".format(args.train_data))
...
if args.dev_data == "asr":
    ...
    dev_path = os.path.join(args.dataroot, "dev_{}_csc.json".format(args.dev_data))
...
model_file_path = args.model+"_"+args.decode+"_"+args.train_data+"_"+args.encoder_cell+"_batch_size{}_lr{}_max_epoch{}_dropout{}_embed_size{}_hidden_size{}_num_layer{}_seed{}".format(args.batch_size,args.lr,args.max_epoch,args.dropout,args.embed_size,args.hidden_size,args.num_layer,args.seed)
