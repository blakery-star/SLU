...
if __name__ == "__main__":
	...
	parser.add_argument("--model_name_or_path", type=str, default="nghuyong/ernie-3.0-base-zh",
	...
	parser.add_argument("--pinyin_vocab_file_path", type=str, default="../../data_pretraining/pinyin_vocab.txt", help="pinyin vocab file path")
